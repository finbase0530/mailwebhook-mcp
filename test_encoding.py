...
if __name__ == "__main__":
    ...
    test_data = {
        "to": TEST_EMAIL,
        "subject": "Python直接测试qqwebhook中文邮件",
        "body": "您好！\n\n这是通过Python脚本直接调用qqwebhook发送的中文邮件。\n\n测试内容：\n• 中文字符：你好世界\n• 特殊符号：©®™\n• Emoji：🎉📧✅\n\n如果显示正常，说明qqwebhook处理中文没有问题。\n\n测试时间：2025年8月16日"
    }
...
def test_mcp_service():
    ...
    mcp_data = {
        "params": {
            ...
            "arguments": {
                "to": TEST_EMAIL,
                "subject": "Python测试MCP中文邮件",
                "body": "您好！\n\n这是通过Python脚本调用MCP服务发送的中文邮件。\n\n测试内容：\n• 中文字符：你好世界\n• 特殊符号：©®™\n• Emoji：🎉📧✅\n\n如果显示正常，说明MCP处理中文没有问题。\n\n测试时间：2025年8月16日",
                "async": False
            }
        }
    }
...
def main():
    ...
    # 测试 qqwebhook
    qqwebhook_success = test_qqwebhook_direct()
    print()
